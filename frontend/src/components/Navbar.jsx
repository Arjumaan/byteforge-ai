    ...
    <nav className="bg-white dark:bg-night-950 border-b border-gray-100 dark:border-night-900 sticky top-0 z-50 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-4 lg:px-4">
        <div className="flex items-center justify-between h-10">
          {/* Logo */}
          <Link to="/chat" className="flex items-center gap-1.5 min-w-fit">
            <img src={logo} alt="ByteForge AI" className="w-5 h-5 object-contain" />
            <span className="text-sm font-black bg-gradient-to-r from-primary-600 to-accent-purple bg-clip-text text-transparent tracking-tighter">ByteForge</span>
          </Link>
