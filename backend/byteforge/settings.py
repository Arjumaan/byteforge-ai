"""
Django settings for byteforge project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ukq9vocm5(_+@(w4^bvpn355p!^o_ps8tuett1@lj*)aek^s9&')
...
SOCIAL_AUTH_APPLE_KEY_ID = os.getenv('APPLE_CLIENT_ID', '')
...
# Token Limits
DEFAULT_CONVERSATION_TOKEN_LIMIT = 20000
